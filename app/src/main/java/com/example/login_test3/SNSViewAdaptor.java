...
public class SNSViewAdaptor extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        post_date.setText(snsViewItem.getPubDate());
    ...
    */
    ...
    /* 네이버 블로그 검색 중, 제목, 내용, 블로거이름, 포스팅 일자, 포스트 링크를 그릇에 담음 */
    public void addItem(String title, String description, String pubdate, String link) {

        SNSViewItem mItem = new SNSViewItem();

        mItem.setTitle(title);
        mItem.setDescription(description);
        mItem.setPubDate(pubdate);
        mItem.setNewslink(link);
